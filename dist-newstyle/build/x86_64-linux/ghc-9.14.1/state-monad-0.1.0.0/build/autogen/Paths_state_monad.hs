...
-- at runtime using the environment variable state_monad_bindir.
...
-- environment variable state_monad_libdir.
...
-- using the environment variable state_monad_dynlibdir.
...
-- runtime using the environment variable state_monad_datadir.
...
-- variable state_monad_libexedir.
...
-- using the environment variable state_monad_sysconfdir.
...
bindir     = "/home/nagarath/.cabal/bin"
libdir     = "/home/nagarath/.cabal/lib/x86_64-linux-ghc-9.14.1-ade7/state-monad-0.1.0.0-inplace"
dynlibdir  = "/home/nagarath/.cabal/lib/x86_64-linux-ghc-9.14.1-ade7"
datadir    = "/home/nagarath/.cabal/share/x86_64-linux-ghc-9.14.1-ade7/state-monad-0.1.0.0"
libexecdir = "/home/nagarath/.cabal/libexec/x86_64-linux-ghc-9.14.1-ade7/state-monad-0.1.0.0"
sysconfdir = "/home/nagarath/.cabal/etc"

getBinDir     = catchIO (getEnv "state_monad_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "state_monad_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "state_monad_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "state_monad_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "state_monad_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "state_monad_sysconfdir") (\_ -> return sysconfdir)
